                        ...
                        @endif
                          <div class="row">
                            <div class="col-md-6">
                                   ...
                                   <form action="childcategorytwo" method="post">
                                     {{ csrf_field() }} 
                                     <label>Category <span>*</span> </label>
                                      <select  name="category_id" id="category1" style="border-color: rgb(107, 213, 234)" >
                                    ...
                                    <br><br><br><br>
                                     ...
                                     <div id="sub1"></div>
                                      <br>
                                       <label>Child category <span>*</span> </label>                    
                                     <div id="child"></div>

                                 <div class="col-md-6 col-sm-6 field">
                                <label>Child Categories Name <span>*</span> </label>
                                <input type="text" placeholder="child categories" name="childcategory2" style="border-color: rgb(107, 213, 234)">
                                @if ($errors->has('childcategory2'))
                                <div class="error">{{ $errors->first('childcategory2') }}</div>
                                @endif
                              </div>
                                    <div class="col-md-12">
                                      <div class="buttonz">
                                        <button type="submit" name="save" onclick="#link3">Add child Category</button>
                                        <a href="back" title="" class="btn-st blu-clr">BACK</a>
                                      </div>
                                        </div>
                                      </form>
                        </div>
           ...
           $.ajax(
         {
           ...
           {       
                ...
                $('#child').empty();
                 ...
                 var toAppend = '<select name="childcategory_id" >';
