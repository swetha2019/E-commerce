...
<!-- Mirrored from warethemes.com/html/martfury/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Jun 2019 07:26:53 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>Martfury - Multi Vendor &amp; Marketplace</title><link href="https://fonts.googleapis.com/css?family=Work+Sans:300,400,500,600,700&amp;subset=latin-ext" rel="stylesheet">
    <link rel="stylesheet" href="template2/plugins/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="template2/fonts/Linearicons/Linearicons/Font/demo-files/demo.css">
    <link rel="stylesheet" href="template2/plugins/bootstrap4/css/bootstrap.min.css">
    <link rel="stylesheet" href="template2/plugins/owl-carousel/assets/owl.carousel.css">
    <link rel="stylesheet" href="template2/plugins/slick/slick/slick.css">
    <link rel="stylesheet" href="template2/plugins/lightGallery-master/dist/css/lightgallery.min.css">
    <link rel="stylesheet" href="template2/plugins/jquery-bar-rating/dist/themes/fontawesome-stars.css">
    <link rel="stylesheet" href="template2/plugins/jquery-ui/jquery-ui.min.css">
    <link rel="stylesheet" href="template2/plugins/select2/dist/css/select2.min.css">
  ...
  <body>
      ...
      <div class="header__top">
        <div class="ps-container">
          <div class="header__left">
            ...
            </div><a class="ps-logo" href="index-2.html"><img src="template2/img/logo_light.png" alt=""></a>
          </div>
          <div class="header__center">
            <form class="ps-form--quick-search" action="http://warethemes.com/html/martfury/index.html" method="get">
                ...
                <div class="ps-cart__content">
                  <div class="ps-cart__items">
                    <div class="ps-product--cart-mobile">
                      <div class="ps-product__thumbnail"><a href="#"><img src="template2/img/products/clothing/7.jpg" alt=""></a></div>
                      <div class="ps-product__content"><a class="ps-product__remove" href="#"><i class="icon-cross"></i></a><a href="product-default.html">MVMTH Classical Leather Watch In Black</a>
                        <p><strong>Sold by:</strong>  YOUNG SHOP</p><small>1 x $59.99</small>
                      </div>
                    </div>
                    <div class="ps-product--cart-mobile">
                      <div class="ps-product__thumbnail"><a href="#"><img src="template2/img/products/clothing/5.jpg" alt=""></a></div>
        ...
        <div class="ps-container">
          ...
          <div class="navigation__right">
            ...
            <ul class="navigation__extra">
              ...
              <li>
                <div class="ps-dropdown language"><a href="#"><img src="template2/img/flag/en.png" alt="">English</a>
                  <ul class="ps-dropdown-menu">
                    <li><a href="#"><img src="template2/img/flag/germany.png" alt=""> Germany</a></li>
                    <li><a href="#"><img src="template2/img/flag/fr.png" alt=""> France</a></li>
                  </ul>
                </div>
              </li>
            </ul>
    ...
    <header class="header header--mobile" data-sticky="true">
      ...
      <div class="navigation--mobile">
        <div class="navigation__left"><a class="ps-logo" href="index-2.html"><img src="template2/img/logo_light.png" alt=""></a></div>
        <div class="navigation__right">
      ...
      <div class="ps-search--mobile">
        <form class="ps-form--search-mobile" action="http://warethemes.com/html/martfury/index.html" method="get">
    ...
    <div class="navigation--list">
      <div class="navigation__content"><a class="navigation__item" href="index-2.html"><i class="icon-home"></i><span> Home</span></a><a class="navigation__item ps-toggle--sidebar" href="#navigation-mobile"><i class="icon-menu"></i><span> Menu</span></a><a class="navigation__item ps-toggle--sidebar" href="#search-sidebar"><i class="icon-magnifier"></i><span> Search</span></a><a class="navigation__item ps-toggle--sidebar" href="#cart-mobile"><i class="icon-bag2"></i><span> Cart</span></a></div>
    </div>
    ...
    <div id="homepage-1">
        ...
        <div class="ps-container">
          <div class="ps-section__left">
            <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
              <div class="ps-banner"><a href="#"><img src="template2/img/slider/home-1/slide-1.jpg" alt=""></a></div>
              <div class="ps-banner"><a href="#"><img src="template2/img/slider/home-1/slide-2.jpg" alt=""></a></div>
              <div class="ps-banner"><a href="#"><img src="template2/img/slider/home-1/slide-3.jpg" alt=""></a></div>
            </div>
          </div>
          <div class="ps-section__right"><a class="ps-collection" href="#"><img src="template2/img/slider/home-1/promotion-1.jpg" alt=""></a><a class="ps-collection" href="#"><img src="template2/img/slider/home-1/promotion-2.jpg" alt=""></a></div>
        </div>
      </div>
          ...
          <div class="ps-section__content">
            <div class="ps-carousel--nav owl-slider" data-owl-auto="false" data-owl-loop="false" data-owl-speed="10000" data-owl-gap="30" data-owl-nav="true" data-owl-dots="true" data-owl-item="7" data-owl-item-xs="2" data-owl-item-sm="3" data-owl-item-md="4" data-owl-item-lg="5" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">
              ...
              <div class="ps-product ps-product--inner">
                <div class="ps-product__thumbnail"><img src="{{$key->product_image}}" height="218" width="218" ></a>
                  @if($key->discount!=0)
                  <div class="ps-product__badge">-{{$key->discount}}%</div>
                  @endif
                ...
                <div class="ps-product__container">
                  ...
                  @if($key->discount!=0)
                    <label hidden>{{$_Discont=($key->discount/100)*$key->price}}</label>
                    <label hidden>{{$_price=$key->price-$_Discont}}</label>

                  <p class="ps-product__price sale">${{$_price}}<del>${{$key->price}}</del><small>{{$key->discount}}% off</small></p>
                  @else
                  <p class="ps-product__price sale">${{$key->price}}</p>
                  @endif
                  <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">{{$key->product_name}}</a>
              ...
              <!-- <div class="ps-product ps-product--inner">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/home/2.jpg" alt=""></a>
              ...
              <div class="ps-product ps-product--inner">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/home/3.jpg" alt=""></a>
              ...
              <div class="ps-product ps-product--inner">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/home/4.jpg" alt=""></a>
                  <div class="ps-product__badge out-stock">Out Of Stock</div>
                  <ul class="ps-product__actions">
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
              ...
              <div class="ps-product ps-product--inner">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/home/5.jpg" alt=""></a>
                  <div class="ps-product__badge out-stock">Out Of Stock</div>
                  <ul class="ps-product__actions">
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
              ...
              <div class="ps-product ps-product--inner">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/home/6.jpg" alt=""></a>
                  <div class="ps-product__badge out-stock">Out Of Stock</div>
                  <ul class="ps-product__actions">
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
              ...
              <div class="ps-product ps-product--inner">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/home/7.jpg" alt=""></a>
      ...
      <div class="ps-home-ads">
        <div class="ps-container">
          <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 "><a class="ps-collection" href="#"><img src="template2/img/collection/home-1/1.jpg" alt=""></a>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 "><a class="ps-collection" href="#"><img src="template2/img/collection/home-1/2.jpg" alt=""></a>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 "><a class="ps-collection" href="#"><img src="template2/img/collection/home-1/3.jpg" alt=""></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="ps-container">
          ...
          <div class="row">
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
              <div class="ps-block--category"><a class="ps-block__overlay" href="shop-default.html"></a><img src="template2/img/categories/1.jpg" alt="">
                <p>Electronics</p>
              </div>
            </div>
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
              <div class="ps-block--category"><a class="ps-block__overlay" href="shop-default.html"></a><img src="template2/img/categories/2.jpg" alt="">
                <p>Clothings</p>
              </div>
            </div>
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
              <div class="ps-block--category"><a class="ps-block__overlay" href="shop-default.html"></a><img src="template2/img/categories/3.jpg" alt="">
                <p>Computers</p>
              </div>
            </div>
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
              <div class="ps-block--category"><a class="ps-block__overlay" href="shop-default.html"></a><img src="template2/img/categories/4.jpg" alt="">
                <p>Home & Kitchen</p>
              </div>
            </div>
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
              <div class="ps-block--category"><a class="ps-block__overlay" href="shop-default.html"></a><img src="template2/img/categories/5.jpg" alt="">
                <p>Health & Beauty</p>
              </div>
            </div>
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
              <div class="ps-block--category"><a class="ps-block__overlay" href="shop-default.html"></a><img src="template2/img/categories/6.jpg" alt="">
                <p>Health & Beauty</p>
              </div>
            </div>
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
              <div class="ps-block--category"><a class="ps-block__overlay" href="shop-default.html"></a><img src="template2/img/categories/7.jpg" alt="">
                <p>Jewelry & Watch</p>
              </div>
            </div>
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
              <div class="ps-block--category"><a class="ps-block__overlay" href="shop-default.html"></a><img src="template2/img/categories/8.jpg" alt="">
                <p>Technology Toys</p>
              </div>
            </div>
          </div>
      ...
      <div class="ps-product-list ps-clothings">
        <div class="ps-container">
          <div class="ps-section__header">
            ...
            @foreach($category3 as $electric)
          <div class="ps-section__content">
            <div class="ps-carousel--nav owl-slider" data-owl-auto="false" data-owl-loop="false" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="7" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">
              <div class="ps-product">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{$electric->product_image}}" alt=""/></a>
                  <div class="ps-product__badge">-{{$electric->discount}}%%</div>
                  <ul class="ps-product__actions">
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                ...
                <div class="ps-product__container"><a class="ps-product__vendor" href="#">Go Pro</a>
                  <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">{{$electric->product_name}}</a>
                    <div class="ps-product__rating">
                      <select class="ps-rating" data-read-only="true">
                        <option value="1">1</option>
                        <option value="1">2</option>
                    ...
                    @if($electric->discount!=0)
                                  <label hidden>{{$_Discont=($electric->discount/100)*$electric->price}}</label>
                                    <label hidden>{{$_price=$electric->price-$_Discont}}</label>
                    <p class="ps-product__price sale">${{$_price}} <del>${{$electric->price}}</del></p>
                    @else
                    <p class="ps-product__price sale">${{$electric->price}} </p>
                    @endif
                  </div>
              ...
              <div class="ps-product">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/electronic/2.jpg" alt=""/></a>
        ...
        <div class="ps-container">
          ...
          <div class="ps-section__content">
            <div class="ps-carousel--responsive owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="7" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="2" data-owl-item-lg="4" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">
              @foreach($category1 as $mens)

              <div class="ps-product">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{$mens->product_image}}"  height="218" width="218" alt=""/></a>
                  <div class="ps-product__badge">-{{$mens->discount}}%</div>
                  <ul class="ps-product__actions">
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                ...
                <div class="ps-product__container"><a class="ps-product__vendor" href="#"></a>
                  <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">{{$mens->product_name}}</a>
                    <div class="ps-product__rating">
                      <select class="ps-rating" data-read-only="true">
                        <option value="1">1</option>
                        <option value="1">2</option>
                   ...
                   @if($mens->discount!=0)
                                  <label hidden>{{$_Discont=($mens->discount/100)*$mens->price}}</label>
                                    <label hidden>{{$_price=$mens->price-$_Discont}}</label>
                    <p class="ps-product__price sale">${{$_price}} <del>${{$mens->price}}</del></p>
                    @else
                    <p class="ps-product__price sale">${{$mens->price}} </p>
                    @endif
                  </div>
                  <div class="ps-product__content hover"><a class="ps-product__title" href="product-default.html">{{$mens->product_name}}</a>
                    @if($mens->discount!=0)
                                  <label hidden>{{$_Discont=($mens->discount/100)*$mens->price}}</label>
                                    <label hidden>{{$_price=$mens->price-$_Discont}}</label>
                    <p class="ps-product__price sale">${{$_price}} <del>${{$mens->price}}</del></p>
...
<div class="ps-product-list ps-clothings">
        <div class="ps-container">
          ...
          <div class="ps-section__content">
            <div class="ps-carousel--responsive owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="7" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="2" data-owl-item-lg="4" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">
              @foreach($category2 as $women)

              <div class="ps-product">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{$women->product_image}}"  height="218" width="218" alt=""/></a>
                  <div class="ps-product__badge">-{{$women->discount}}%</div>
                  <ul class="ps-product__actions">
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                ...
                <div class="ps-product__container"><a class="ps-product__vendor" href="#"></a>
                  <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">{{$women->product_name}}</a>
                    <div class="ps-product__rating">
                      <select class="ps-rating" data-read-only="true">
                        <option value="1">1</option>
                        <option value="1">2</option>
                    ...
                    @if($women->discount!=0)
                                  <label hidden>{{$_Discont=($women->discount/100)*$women->price}}</label>
                                    <label hidden>{{$_price=$women->price-$_Discont}}</label>
                    <p class="ps-product__price sale">${{$_price}} <del>${{$women->price}}</del></p>
                    @else
                    <p class="ps-product__price sale">${{$women->price}} </p>
                    @endif
                  </div>
                  <div class="ps-product__content hover"><a class="ps-product__title" href="product-default.html">{{$women->product_name}}</a>
                   @if($women->discount!=0)
                                  <label hidden>{{$_Discont=($women->discount/100)*$women->price}}</label>
                                    <label hidden>{{$_price=$women->price-$_Discont}}</label>
                    <p class="ps-product__price sale">${{$_price}} <del>${{$women->price}}</del></p>
      ...
      <div class="ps-product-list ps-clothings">
        <div class="ps-container">
          ...
          <div class="ps-section__content">
            <div class="ps-carousel--responsive owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="7" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="2" data-owl-item-lg="4" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">
              @foreach($category5 as $kid)

              <div class="ps-product">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{$kid->product_image}}"  height="218" width="218" alt=""/></a>
                  <div class="ps-product__badge">-{{$kid->discount}}%</div>
                  <ul class="ps-product__actions">
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                ...
                <div class="ps-product__container"><a class="ps-product__vendor" href="#"></a>
                  <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">{{$kid->product_name}}</a>
                    <div class="ps-product__rating">
                      <select class="ps-rating" data-read-only="true">
                        <option value="1">1</option>
                        <option value="1">2</option>
                    ...
                    @if($kid->discount!=0)
                                  <label hidden>{{$_Discont=($kid->discount/100)*$kid->price}}</label>
                                    <label hidden>{{$_price=$kid->price-$_Discont}}</label>
                    <p class="ps-product__price sale">${{$_price}} <del>${{$kid->price}}</del></p>
                    @else
                    <p class="ps-product__price sale">${{$kid->price}} </p>
                    @endif
                  </div>
                  <div class="ps-product__content hover"><a class="ps-product__title" href="product-default.html">{{$kid->product_name}}</a>
                   @if($kid->discount!=0)
                                  <label hidden>{{$_Discont=($kid->discount/100)*$kid->price}}</label>
                                    <label hidden>{{$_price=$kid->price-$_Discont}}</label>
                    <p class="ps-product__price sale">${{$_price}} <del>${{$kid->price}}</del></p>
        ...
        <div class="ps-container">
          ...
          <div class="ps-section__content">
            <div class="ps-carousel--responsive owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="7" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">
                  @foreach($category4 as $home)
              <div class="ps-product">
                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{$home->product_image}}" alt=""/></a>
                ...
                <div class="ps-product__container"><a class="ps-product__vendor" href="#">Young Shop</a>
                  <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">{{$home->product_name}}r</a>
                    <div class="ps-product__rating">
                      <select class="ps-rating" data-read-only="true">
                        <option value="1">1</option>
                        <option value="1">2</option>
                     ...
                     @if($home->discount!=0)
                                  <label hidden>{{$_Discont=($home->discount/100)*$home->price}}</label>
                                    <label hidden>{{$_price=$home->price-$_Discont}}</label>
                    <p class="ps-product__price sale">${{$_price}} <del>${{$home->price}}</del></p>
                    @else
                    <p class="ps-product__price sale">${{$home->price}} </p>
                    @endif
                  </div>
                  <div class="ps-product__content hover"><a class="ps-product__title" href="product-default.html">{{$home->product_name}}</a>
                    @if($home->discount!=0)
                                  <label hidden>{{$_Discont=($home->discount/100)*$home->price}}</label>
                                    <label hidden>{{$_price=$home->price-$_Discont}}</label>
                    <p class="ps-product__price sale">${{$_price}} <del>${{$home->price}}</del></p>
      ...
      <div class="ps-home-ads">
        <div class="ps-container">
          <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 "><a class="ps-collection" href="#"><img src="template2/img/collection/home-1/ad-1.jpg" alt=""></a>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 "><a class="ps-collection" href="#"><img src="template2/img/collection/home-1/ad-2.jpg" alt=""></a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                  <div class="ps-block__thumbnail"><img src="template2/img/app.png" alt=""></div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                  <div class="ps-block__content">
                    ...
                    <form class="ps-form--download-app" action="http://warethemes.com/html/martfury/do_action" method="post">
                      <div class="form-group--nest">
                        <input class="form-control" type="Email" placeholder="Email Address">
                        <button class="ps-btn">Subscribe</button>
                      </div>
                    </form>
                    <p class="download-link"><a href="#"><img src="template2/img/google-play.png" alt=""></a><a href="#"><img src="template2/img/app-store.png" alt=""></a></p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-product--horizontal">
                  <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/arrivals/1.jpg" alt=""/></a></div>
              ...
              <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-product--horizontal">
                  <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/arrivals/2.jpg" alt=""/></a></div>
              ...
              <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-product--horizontal">
                  <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/arrivals/3.jpg" alt=""/></a></div>
              ...
              <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-product--horizontal">
                  <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/arrivals/4.jpg" alt=""/></a></div>
              ...
              <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-product--horizontal">
                  <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/arrivals/5.jpg" alt=""/></a></div>
              ...
              <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-product--horizontal">
                  <div class="ps-product__thumbnail"><a href="product-default.html"><img src="template2/img/products/arrivals/6.jpg" alt=""/></a></div>
      ...
      <div class="ps-newsletter">
        <div class="ps-container">
          <form class="ps-form--newsletter" action="http://warethemes.com/html/martfury/do_action" method="post">
            <div class="row">
    ...
    <footer class="ps-footer">
      <div class="ps-container">
        ...
        <div class="ps-footer__copyright">
          ...
          <p><span>We Using Safe Payment For:</span><a href="#"><img src="template2/img/payment-method/1.jpg" alt=""></a><a href="#"><img src="template2/img/payment-method/2.jpg" alt=""></a><a href="#"><img src="template2/img/payment-method/3.jpg" alt=""></a><a href="#"><img src="template2/img/payment-method/4.jpg" alt=""></a><a href="#"><img src="template2/img/payment-method/5.jpg" alt=""></a></p>
        </div>
      </div>
    </footer>
    <div class="ps-popup" id="subscribe" data-time="500">
      <div class="ps-popup__content bg--cover" data-background="template2/img/bg/subscribe.jpg"><a class="ps-popup__close" href="#"><i class="icon-cross"></i></a>
        <form class="ps-form--subscribe-popup" action="http://warethemes.com/html/martfury/index.html" method="get">
    ...
    <div class="ps-search" id="site-search"><a class="ps-btn--close" href="#"></a>
      <div class="ps-search__content">
        <form class="ps-form--primary-search" action="http://warethemes.com/html/martfury/do_action" method="post">
    ...
    <!-- Plugins-->
    <script src="template2/plugins/jquery-1.12.4.min.js"></script>
    <script src="../../../cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js"></script>
    <script src="template2/plugins/owl-carousel/owl.carousel.min.js"></script>
    <script src="template2/plugins/bootstrap4/js/bootstrap.min.js"></script>
    <script src="template2/plugins/imagesloaded.pkgd.js"></script>
    <script src="template2/plugins/masonry.pkgd.min.js"></script>
    <script src="template2/plugins/isotope.pkgd.min.js"></script>
    <script src="template2/plugins/jquery.matchHeight-min.js"></script>
    <script src="template2/plugins/slick/slick/slick.min.js"></script>
    <script src="template2/plugins/jquery-bar-rating/dist/jquery.barrating.min.js"></script>
    <script src="template2/plugins/slick-animation.min.js"></script>
    <script src="template2/plugins/lightGallery-master/dist/js/lightgallery-all.min.js"></script>
    <script src="template2/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="template2/plugins/sticky-sidebar/dist/sticky-sidebar.min.js"></script>
    <script src="template2/plugins/jquery.slimscroll.min.js"></script>
    <script src="template2/plugins/select2/dist/js/select2.full.min.js"></script>
    <script src="template2/plugins/gmap3.min.js"></script>
    <!-- Custom scripts-->
    <script src="template2/js/main.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDxflHHc5FlDVI-J71pO7hM1QJNW1dRp4U&amp;region=GB"></script>
  </body>

<!-- Mirrored from warethemes.com/html/martfury/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Jun 2019 07:28:17 GMT -->
</html>