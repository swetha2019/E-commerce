                          ...
                          <div class="product-detail paddlr100">
                            <div class="row">
                              <div class="col-lg-5 col-md-5">
                                ...
                                ?>
                                <div class="product-detail-thumb"> <img src="<?php echo $value->product_image; ?>" alt=""> </div>
                              </div>
                              <div class="col-lg-7 col-md-7">
                                <div class="product-detail-info">
                                  ...
                                  <span class="price"> <ins>$<?php echo $value->price; ?></ins> <del>$<?php echo $value->discount; ?></del> </span>
                                  <div class="cart-quantity">
                                    <form>
                                      <label>Quantity:</label>
                                      <input  type="text" name="value" value="<?php echo $value->product_quantity; ?>">
                                    </form> 
                                    <?php $id =  $value->id;?>
                                    <a class="addcart" href="{{url('edit_product',$id)}}" title="">Edit Details</a>
                                  </div>
                                </div>
                              </div>
                            </div>
