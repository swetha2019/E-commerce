          ...
          <div class="main-content">
            ...
            <div class="panel-body">
              ...
              <div class="content-area">
                ...
                <td><?php $id = $value->id;?><a href="{{url('view_product_details',$id)}}"><?php echo $value->product_name;?></a></td>
                <td><?php echo $value->category_name;?></td> 
                <td><?php echo $value->subcategory_name;?></td>                    
                <td><?php echo $value->price;?></td> 
                <td><?php echo $value->discount;?>%</td>
                 <?php $id =  $value->id;?>
                <td><a href="{{url('product_image_view',$id)}}"><img src="<?php echo $value->product_image; ?>"  style="width: 100px; height: 150px ;"></a></td>
